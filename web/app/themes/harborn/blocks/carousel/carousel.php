...
if ( $projects_query->have_posts() ) { ?>
	<div id="<?php echo esc_attr( $carousel_block_id ); ?>" class="<?php echo esc_attr( $carousel_block_class ); ?>">
		<div class="carousel-block__header">
			<h2 class="carousel-block__title">Work</h2>
			<div class="more-work-link-bg">
				<a href="/projects" class="more-work-link">
					More Work <svg class="arrow" width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg"><path d="M8 0L6.59 1.41L12.17 7H0V9H12.17L6.59 14.59L8 16L16 8L8 0Z" fill="currentColor"/></svg>
				</a>
			</div>
		</div>
