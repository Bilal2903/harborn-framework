 ...
 */
if ( ! env( 'WP_ENVIRONMENT_TYPE' ) && in_array( WP_ENV, array( 'production', 'staging', 'development', 'local' ), true ) ) {
...
// phpcs:ignore WordPress.WP.GlobalVariablesOverride.Prohibited -- Required for table prefix.
...
Config::define( 'WP_POST_REVISIONS', env( 'WP_POST_REVISIONS' ) ? env( 'WP_POST_REVISIONS' ) : true );
